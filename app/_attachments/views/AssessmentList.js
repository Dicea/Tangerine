(function() {
  ...
  AssessmentListView = (function(_super) {
    ...
    AssessmentListView.prototype.templateTableRow = Handlebars.compile("    <tr>      <td>        <div class='assessment-name'>{{name}}</div>        <a href='#assessment/{{id}}'>Perform Assessment</a><br>        <a href='#results/{{id}}/{{enumerator}}'>Results</a>      </td>      <td class='number-completed-by-current-enumerator'>        {{number_completed}}      </td>    </tr>  ");

...
ResultsPageView = (function(_super) {

  __extends(ResultsPageView, _super);

  function ResultsPageView() {
    this.render = __bind(this.render, this);
    ResultsPageView.__super__.constructor.apply(this, arguments);
  }

  ResultsPageView.prototype.el = '#content';

  ResultsPageView.prototype.render = function() {
    var _this = this;
  ...
  ResultsPageView.prototype.events = {
  ...
  ResultsPageView.prototype.updateLastCloudReplication = function() {
  ...
  ResultsPageView.prototype.save = function(event) {
    return this.replicate($(event.target).attr("saveTarget"));
  };

  ResultsPageView.prototype.detect = function() {
    $("#saveOptions").html("<span id='saveMessage'>Detecting</span>");
    this.detectCloud();
    return this.detectSubnet();
  };

  ResultsPageView.prototype.detectCloud = function() {
  ...
  ResultsPageView.prototype.detectSubnet = function() {
  ...
  ResultsPageView.prototype.detectIP = function(options) {
    return $.ajax({
      dataType: "jsonp",
      url: options.url,
      success: function() {
  ...
  ResultsPageView.prototype.replicate = function(target) {
  ...
  ResultsPageView.prototype.csv = function() {
    return Tangerine.router.navigate("results/tabular/" + this.databaseName, true);
  };

  ResultsPageView.prototype.updateTable = function() {
  ...
  ResultsPageView.prototype.downloadCSV = function() {
    return $("table#results").table2CSV();
  };

  ResultsPageView.prototype.renderTable = function(options) {
